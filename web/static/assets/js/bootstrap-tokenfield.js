...
(function (factory) {
  ...
  * ============================== */
  ...
  , createToken: function (attrs, triggerChange) {  //TODO createToken
      ...
      var $token = $('<div class="token" />')
            ...
            .data('attrs', attrs)
          console.log("createToken : " + attrs.value) //TODO createToken2
  ...
  , setTokens: function (tokens, add, triggerChange) {
      ...
      console.log("setTokens value [0]: " + tokens[0]); //TODO setTokens
      var _self = this
  ...
  , getTokenData: function($token) {
      ...
      if (data.length == 1) {
        ...
        console.log("getTokenData : "+ data[0]) // TODO getTOkenData
      return data;
    }
      ...
      switch(e.keyCode) {
        ...
        case 13: // enter
          ...
          if (this.$input.is(document.activeElement) && this.$input.val().length || this.$input.data('edit')) {
              console.log("create"+ this.createTokensFromInput(e, this.$input.data('edit')));
  ...
  , createTokensFromInput: function (e, focus) {
      ...
      var tokensBefore = this.getTokensList()
          console.log("tokensBefore : " + tokensBefore); //TODO tokensBefore
          console.log("tokensBefore input.val() : " + this.$input.val())
